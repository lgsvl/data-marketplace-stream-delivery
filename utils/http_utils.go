...
func HttpExecuteWithHeader(logger *log.Logger, httpClient *http.Client, requestType string, requestURL string, rawPayload interface{}, headers map[string]string) (*http.Response, error) {
